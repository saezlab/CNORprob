...
if (Selected_Model==1) {
  ...
  estim <- CNORprob_buildModel(CNOlist,model,expandOR=FALSE,HardConstraint=FALSE,Force=FALSE,L1Reg=L1Reg,HLbound=HLbound,SSthresh=SSthresh,PlotIterations=PlotIterations,rsolnp_options=rsolnp_options)
